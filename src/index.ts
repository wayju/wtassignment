...
app.description(
  'Console application for fetching IP addresses for hostnames for the purpose of detecting changes. Output will include both hostnames which have changed and those which have not. \n\nUses the google DoH api to fetch the IP Address from DNS A records.\n\nNote that results may not be returned in the same order as input.'
);
app.requiredOption(
  '-F, --file <filename>',
